function App (){
  ...
  return(
    ...
    <div id="racetrack">
      <img src="/Asset/car22.png" alt="Car 1" id="car1" className="car" width="200px" height="100px"/>
      <img src="/Asset/image4.png" alt="car 2" id="car2" className="car" width="150px" height="100px"/>
    </div>
